...
outprefix=${PBS_O_WORKDIR}/peakMatrices/PerReadCounts/${prefix}

Rscript /rds/general/project/lms-spivakov-analysis/live/chicago/chicagoTools/makePeakMatrix.R ${listfile} ${outprefix} --fetchcol N --scorecol score --cutoff 5 > makePeakMatrix_single.${PBS_JOBID}.log 2>&1
